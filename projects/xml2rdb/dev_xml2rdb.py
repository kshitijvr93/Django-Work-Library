# development xml2rdb-development
...
def node_visit_output_test(node=None, node_index=None, d_namespaces=None,
...
NOTE: see also in rdb2xml inverse method rdb_to_xml()
'''
def xml_doc_rdb(
    od_relation=None
    ,output_folder=None
