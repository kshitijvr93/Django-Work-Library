...
a single bibvid item its mets data
parse item metadata into xml
RETURN:root node
'''
...
def get_tree_and_root_from_file(input_file_name=None, log_file=None,
    verbosity=None):
    me = 'get_tree_and_root_from_file'
...
if __name__ == "__main__":
    ...
    backup_folder = None
    replace_children = False
    #20180625b - use backup_folder=None - now we assume we have sub folder
