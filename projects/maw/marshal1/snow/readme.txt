...
This application allows users to create their own arbitrary
snowflake hierarchies, here in relation snow_genre, each of
which is supposed to correspond to a nested data structure such
as an XML document, JSON structure, YAML structure, or the like.
...
be written/ expressed as the xml node text rather than a named
xml tag attribute.
