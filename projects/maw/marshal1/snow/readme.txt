...
each of which is supposed to correspond to a nested data structure such as an
XML document, JSON structure, YAML structure, or the like.

This application allows the user to create a schema to define all the relational
tables in any snowflake hierarchy they chose to create via the web interface.

See table models.py and note simmilarities with xsd schema descriptions, facets,
