# Generated by Django 2.0.7 on 2018-11-16 16:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('batch_set', models.ForeignKey(help_text='BatchSet for which to generate SubjectApp JP2 Packages', on_delete=django.db.models.deletion.CASCADE, related_name='test_batch_set', to='dps.BatchSet')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='test_user', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Jp2Job2',
            fields=[
                ...
                ('end_datetime', models.DateTimeField(editable=False, null=True, verbose_name='End DateTime (UTC)')),
                ('status', maw_utils.SpaceTextField(blank=True, default='', help_text='Status of ongoing or completed run. Check for status updates as packages are being built.', max_length=2550, null=True, verbose_name='Run Status')),
                ('batch_set', models.ForeignKey(help_text='BatchSet for which to generate Hathitrust JP2 Packages', on_delete=django.db.models.deletion.CASCADE, related_name='test_batch_set2', to='dps.BatchSet')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='test_user2', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('charset', models.CharField(blank=True, max_length=32, null=True, verbose_name='char_set')),
                ('url', models.CharField(default='tmpfile', max_length=256, verbose_name='url')),
                ('item', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='subject_app.Item')),
            ],
        ),
        migrations.CreateModel(
            name='Yaml',
        ...
        migrations.AddField(
            ...
            name='yaml',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='subject_app.Yaml'),
        ),
        migrations.AddField(
            model_name='file',
            name='item',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='subject_app.Item'),
        ),
        migrations.AddField(
