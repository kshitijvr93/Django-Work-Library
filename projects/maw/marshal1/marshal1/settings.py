...
settings from the executing user's my_secrets folder and it python files.

Originally Generated by 'django-admin startproject' using Django 1.11.5.
"""

import os
import sys, os.path, getpass, platform
...
#import my_secrets.maw_settings
...
if MAW_ENV == 'production':
    DATABASES['lcroyster_connection'] = {
        ...
        'PASSWORD': MAW_LCROYSTER_PRODUCTION_PASSWORD,
    ...
    DATABASES = {
        ...
        'default': {
            ...
            'USER': 'podengo',
            'PASSWORD': MAW_DEFAULT_LOCAL_PASSWORD,
            'HOST': '127.0.0.1',
            'PORT': '3306',
        },
        'maw1_db_connection': {
        ...
        'lcroyster_connection': {
            ...
            'NAME': 'lcroyster1',
            'USER': 'podengo',
            'PASSWORD': MAW_HATHITRUST_LOCAL_PASSWORD,
            'HOST': '127.0.0.1',
            'PORT': '3306',
        },
        ...
        'cuba_libro_connection': {
            ...
            'NAME': 'maw1_db',
            'USER': 'podengo',
            'PASSWORD': MAW_CUBA_LIBRO_LOCAL_PASSWORD,
            'HOST': '127.0.0.1',
            'PORT': '3306',
        },
    } # END DATABASES
