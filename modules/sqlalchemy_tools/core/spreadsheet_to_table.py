...
The 'columns' list must be of sqlalchemy returned "Column()" objects.
...
def run(env=None):
    ...
    #WINDOWS
    nickname = 'uf_local_silodb'
    nickname = 'uf_local_mysql_marshal1'
    nickname = 'integration_sobekdb'
    ...
    print(
      ...
      .format(me,env,workbook_path,sheet_index,
        od_index_column,engine_nickname,table_name))
