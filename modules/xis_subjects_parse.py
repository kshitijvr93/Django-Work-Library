'''
xis_subjects_parse.py

Python 3.6+ code
'''

'''
This program converts a xis-dataharmony v3.1.3 exported file of UF
subject terms, attaching certain implied attributes and sub-elements
to output a more detailed xml formatted file. The output file is suitable
to be converted to relational db format by the UF xml2rdb program.


The head of a sample input file has sequence of these 'item' subject term
info sections:
...
def run():
    ...
    ofn =  r'C:\rvp\data\xis\export_subjects\xis_subjects_parsed_20181021.xml'
